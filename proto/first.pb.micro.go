...
type SayService interface {
	...
	All(ctx context.Context, in *empty.Empty, opts ...client.CallOption) (*Response, error)
}
...
func (c *sayService) All(ctx context.Context, in *empty.Empty, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Say.All", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type SayHandler interface {
	...
	All(context.Context, *empty.Empty, *Response) error
}

func RegisterSayHandler(s server.Server, hdlr SayHandler, opts ...server.HandlerOption) error {
	type say interface {
		Hello(ctx context.Context, in *Request, out *Response) error
		All(ctx context.Context, in *empty.Empty, out *Response) error
	}
	type Say struct {
		say
	}
...
func (h *sayHandler) All(ctx context.Context, in *empty.Empty, out *Response) error {
	return h.SayHandler.All(ctx, in, out)
}
